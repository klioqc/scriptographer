...
public class ImageButton extends Button {
	...
	/*
	 * todo ? public ImageButtonStyle getStyle() { return
	 * IntegerEnumUtils.get(ImageButtonStyle.class, nativeGetStyle()); }
	 * 
	 * public void setStyle(ImageButtonStyle style) { if (style != null)
